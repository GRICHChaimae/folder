...
<p id="logo">My Baby</p>
<div class="bgrForm">
<form action="{{ route('check') }}" method="post" class="formContainer">
    @csrf
    <div class="results">
        @if(Session::get('fail'))
        ...
        <input type="text" name="email" placeholder="Prenom" class="mb-2" value="{{ old('email') }}">
        <span style="color:red">@error('email') {{ $message }}  @enderror</span>
        <input type="password" name="mot_de_passe" placeholder="Prenom" class="mb-2" value="{{ old('mot_de_passe') }}">
